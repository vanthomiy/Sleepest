...
namespace SleepestTest1.Authentification.Service
{
    public static class ProviderService
    {
        ...
        public static async Task<string> PostGoogleAsync(string url, string requestBody)
        {
            ...
            HttpClient httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = authHeader;
            //httpClient.DefaultRequestHeaders.Add("Authorization", "Bearer " + googleToken);
            //var content = new StringContent("{\"aggregateBy\":[{\"dataTypeName\":\"com.google.step_count.delta\",\"dataSourceId\":\"derived:com.google.step_count.delta:com.google.android.gms:estimated_steps\"}],\"bucketByTime\":{\"durationMillis\":86400000},\"startTimeMillis\":1610705622000,\"endTimeMillis\":1614353580202}", Encoding.UTF8, "application/json");
